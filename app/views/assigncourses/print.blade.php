				...
				<table>
					<tbody>
						...
						<tr>
							...
							<td style="text-align:right">{{$results[0]->installmentDate}}</td>
						...
						<tr>
							...
							<td style="text-align:right">{{$results[0]->paidDate}}</td>
			
						</tr>

			<tr>
							<td style="text-align:left" width="75"><b>	Installment Amount(in Rs.)	</b></td>
							<td style="text-align:right" width="120">{{$results[0]->installmentAmount}}</td>
							<td width="50">&nbsp;</td>
							<td style="text-align:left"><b>Remaining Amount (in Rs.)</b></td>
							<td style="text-align:right">{{$results[0]->remainingAmount}}</td>
						...
						<tr>
						 ...
						 <td width="50">&nbsp;</td>
							...
							<td style="text-align:right">{{$results[0]->paidAmount}}</td>
